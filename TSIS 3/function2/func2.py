...
def sublist_imdb_above_5_5(movie_list):
...
n = int(input())
movie = movies[n]
print("IMDB score above 5.5:", imdb_above_5_5(movie))
print("Movies with IMDB score above 5.5:", sublist_imdb_above_5_5(movies))
print("Movies in category 'Romance':", filter_by_category(movies, "Romance"))
print("Average IMDB score of all movies:", average_imdb_score(movies))
print("Average IMDB score of category 'Romance':", average_imdb_score_by_category(movies, "Romance"))
